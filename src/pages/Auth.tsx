...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Left side - branding */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center" style={{background: "radial-gradient(ellipse 90% 90% at 65% 45%, #c2410c 0%, #9a3412 40%, #14532d 75%, #052e16 100%)"}}>
        ...
        <div className="relative z-10 text-primary-foreground px-12 max-w-lg">
          ...
          <p className="text-lg text-primary-foreground/80 leading-relaxed">
            Edite qualquer PDF com total controle. Sem softwares complexos, 100% online.
          </p>
        </div>
      </div>
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              {isLogin ? "Entre para continuar editando" : "Comece a editar seus PDFs agora"}
            </p>
          </div>
