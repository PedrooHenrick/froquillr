...
const BeforeAfterSection = () => (
  <motion.div
    ...
    className="mb-10 bg-white border border-border rounded-2xl overflow-hidden"
  >
    <div className="px-6 py-4 border-b border-border flex items-center justify-between">
      <div>
        <h3 className="font-bold text-foreground text-sm">Veja o que voce pode fazer</h3>
        <p className="text-xs text-muted-foreground mt-0.5">Edite nomes, datas, assinaturas e muito mais</p>
      </div>
    ...
    <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-border">
      {/* Antes */}
      <div className="p-6">
        <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-3">Antes</p>
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 font-mono text-xs text-gray-700 space-y-2 select-none">
          <p className="text-center font-bold text-base text-gray-900 mb-3">CERTIFICADO</p>
          <p>Certificamos que o Sr. <span className="bg-red-100 text-red-700 px-1 rounded">João da Silva</span>,</p>
          <p>Portador do CPF: <span className="bg-red-100 text-red-700 px-1 rounded">123.456.789-00</span>,</p>
          <p>Participou do curso de NR-18 realizado</p>
          <p>no dia <span className="bg-red-100 text-red-700 px-1 rounded">01 de Janeiro de 2024</span>,</p>
          <p>com carga horaria de 6 Horas.</p>
      ...
      {/* Depois */}
      <div className="p-6">
        <p className="text-xs font-semibold text-orange-500 uppercase tracking-wide mb-3">Depois ✨</p>
        <div className="bg-gray-50 rounded-xl p-4 border border-orange-200 font-mono text-xs text-gray-700 space-y-2 select-none">
          <p className="text-center font-bold text-base text-gray-900 mb-3">CERTIFICADO</p>
          ...
          <p>Participou do curso de NR-18 realizado</p>
          <p>no dia <span className="bg-green-100 text-green-700 px-1 rounded">15 de Marco de 2025</span>,</p>
          <p>com carga horaria de 6 Horas.</p>
          <div className="mt-4 pt-3 border-t border-gray-200 flex justify-between text-[10px] text-gray-500">
            <div>
